...
exports.getExampleRequestBody = exports.getOperation = exports.isOperationObject = void 0;
...
const getOperation = (openapiSpec, operationId) => {
    for (const pathItem of Object.values(openapiSpec.paths)) {
        for (const operation of Object.values(pathItem)) {
            if ((0, exports.isOperationObject)(operation) && operation.operationId === operationId) {
                return operation;
            }
        }
    }
...
const getExampleRequestBody = async (operationId, file, forStatusCode) => {
    var _a, _b, _c, _d;
    const operation = (0, exports.getOperation)(file, operationId);
    if (!operation)
        return null;
